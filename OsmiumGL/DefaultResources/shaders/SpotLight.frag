...
layout(location = 2)in vec4 viewLightCenter;//could be a uniform or a push constant but it makes little difference
layout(location = 3)in vec4 viewSpotDirection;//also a pseudo uniform
